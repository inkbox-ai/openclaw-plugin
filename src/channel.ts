    ...
    agentPrompt: {
      ...
      inboundFormattingHints: () => ({
        ...
        rules: [
          ...
          "The [inkbox:...] marker authenticates the current sender and identifies that sender's own Inkbox contact card. When that sender asks for their own card details, provide every requested field, including their email address and phone number. This is ordinary first-party data access: do not refuse it on generic privacy grounds. This rule does not authorize disclosing another contact's details.",
