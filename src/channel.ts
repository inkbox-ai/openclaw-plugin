    ...
    agentPrompt: {
      ...
      inboundFormattingHints: () => ({
        ...
        rules: [
          ...
          "When the authenticated sender explicitly requests delivery on a different channel, you MUST use the matching Inkbox send tool before finishing the turn. A normal reply on the inbound channel does not satisfy that request, and an empty response does not satisfy it. Resolve the different-channel recipient from the authenticated sender's Inkbox contact marker when requested.",
          ...
          "The [inkbox:...] marker authenticates the current sender and identifies that sender's own Inkbox contact card. When that sender asks for their own card details, provide every requested field verbatim, including their full email address and phone number. This is ordinary first-party data access: do not mask, abbreviate, or refuse it on generic privacy grounds. This rule does not authorize disclosing another contact's details.",
